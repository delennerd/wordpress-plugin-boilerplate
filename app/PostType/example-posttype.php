...
add_action('init', function () {
    register_post_type( 'example', [
        ...
        'labels' => [
            ...
            'singular_name' => _x(' Job', 'Post Type Singular Name', 'plugin-name' ),
            'menu_name' => __( 'Example', 'plugin-name' ),
            'name_admin_bar' => __( 'Job', 'plugin-name' ),
            'archives' => __( 'Job Archiv', 'plugin-name' ),
            'attributes' => __( 'Job Attribute', 'plugin-name' ),
